      ...
      <main className="relative pl-32 pr-8 pt-8 min-h-screen max-w-[1600px] mx-auto transition-all duration-500">
        ...
        <header className="flex items-center justify-between mb-10">
          <div>
            ...
            <p className="text-gray-200 text-sm mt-1 flex items-center gap-2 font-medium">
              <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse shadow-[0_0_8px_#10b981]" />
              Live AI Oversight <span className="text-gray-500 mx-1">|</span> <span className="text-[#d4af37]">2026 Protocol Active</span>
            </p>
          </div>
          
          <div className="flex items-center gap-6">
            <div className="hidden md:flex items-center gap-4 bg-white/10 border border-white/20 px-5 py-2.5 rounded-full focus-within:border-[#d4af37] transition-all group">
              <Search size={18} className="text-gray-400 group-focus-within:text-[#d4af37]" />
              <input 
                type="text" 
                placeholder="Search leads, GCI, or territory..." 
                className="bg-transparent border-none outline-none text-sm w-72 placeholder-gray-500 text-white font-medium"
              />
            </div>
            <button className="relative p-2.5 bg-white/5 border border-white/10 rounded-full text-white hover:border-[#d4af37]/50 hover:bg-white/10 transition-all">
              <Bell size={20} />
              <span className="absolute top-2 right-2 w-2.5 h-2.5 bg-[#d4af37] rounded-full border-2 border-[#020202]" />
            </button>
            <div className="flex items-center gap-3 pl-6 border-l border-white/10">
              <div className="text-right">
                <p className="text-sm font-bold text-white tracking-tight">Barry Cohen Group</p>
                <p className="text-[10px] text-[#d4af37] uppercase tracking-widest font-black">Principal Partner</p>
              </div>
              <div className="w-11 h-11 rounded-full gold-gradient p-[1.5px] shadow-lg">
                <div className="w-full h-full rounded-full bg-black flex items-center justify-center overflow-hidden">
                  <img src="https://picsum.photos/200" alt="Avatar" className="w-full h-full object-cover grayscale brightness-125" />
                </div>
              </div>
            </div>
          </div>
        ...
        <footer className="mt-20 pt-16 pb-12 border-t border-white/10 bg-[#020202]">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
            ...
            {/* District Expertise Column */}
            <div>
              <h4 className="text-white font-bold text-xs uppercase tracking-[0.3em] mb-6 flex items-center gap-2">
